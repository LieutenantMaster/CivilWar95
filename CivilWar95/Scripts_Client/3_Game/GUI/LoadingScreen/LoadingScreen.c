...
modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
		...
		m_ExHintIcon = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets(CW95_PATH_GUI + "layouts\\hint_icon.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.LogoPath != string.Empty)
		{
			...
			m_ImageLogoCorner = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets(CW95_PATH_GUI + "layouts\\logo.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.LoadingBarColor != 0)
		{
			...
			m_ProgressLoading = ProgressBarWidget.Cast(game.GetLoadingWorkspace().CreateWidgets(CW95_PATH_GUI + "layouts\\loading_bar.layout", m_ExPanelWidget));
