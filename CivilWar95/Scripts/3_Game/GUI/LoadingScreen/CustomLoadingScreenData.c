class CustomLoadingScreenData
{
	...
	string HintIconPath = CV95_PATH_GUI + "icons\\circle_info.edds";
	...
	void CustomLoadingScreenData()
	{
		...
		JsonFileLoader<array<ref CustomLoadingScreenBackground>>.JsonLoadFile(CV95_PATH_SCRIPTS + "Data\\LoadingImages.json", m_ExBackgrounds);
	}
};