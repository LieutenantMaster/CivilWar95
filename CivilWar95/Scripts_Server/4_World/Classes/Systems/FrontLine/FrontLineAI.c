...
class FrontLineAI: FrontLineEventBase
{
	...
	eAIBase SpawnAI(eAIBase owner, string loadout)
	{
    ...
    {
        int rndFormation = Math.RandomFloatInclusive(0, CW95FormationsAI.COUNT);
        switch (rndFormation)
        {
            default:
            case CW95FormationsAI.FOR_VEE:
                return new eAIFormationVee(g);
                break;
            case CW95FormationsAI.FOR_INVVEE:
                return new eAIFormationInvVee(g);
                break;
            case CW95FormationsAI.FOR_FILE:
                return new eAIFormationFile(g);
                break;
            case CW95FormationsAI.FOR_INVFILE:
                return new eAIFormationInvFile(g);
                break;
            case CW95FormationsAI.FOR_WALL:
                return new eAIFormationWall(g);
                break;
            case CW95FormationsAI.FOR_COL:
                return new eAIFormationColumn(g);
                break;
            case CW95FormationsAI.FOR_INVCOL:
                return new eAIFormationInvColumn(g);
                break;
            case CW95FormationsAI.FOR_CIRCLE:
                return new eAIFormationCircle(g);
                break;
            case CW95FormationsAI.FOR_CIRCLEDOT:
                return new eAIFormationCircleDot(g);
                break;
            case CW95FormationsAI.FOR_STAR:
                return new eAIFormationStar(g);
                break;
            case CW95FormationsAI.FOR_STARDOT:
